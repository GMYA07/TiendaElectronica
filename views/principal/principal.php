    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <div class="card-wrapper container-sm d-flex  justify-content-around">
                ...
                <div class="card impar" style="width: 18rem;">
                    <img src="./Assets/img/productos/ups.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Ups forza interactivo nt-2401pro 2400va 1200w 10 salidas nema 5-15r</h5>
                    </div>
                    <div class="card-precio">
                        <p>$ 169.95</p>
                    </div>
...
<div class="container contenedorNovedades">
    ...
    <div class="container contenedorBotonVerMas ">
        <div class="card-boton">
            <button type="button" id="vermasNovedades" class="btn btn-primary">Ver mas</button>
        </div>
    </div>
</div>
...
<div class="container contenedorOfertas">
